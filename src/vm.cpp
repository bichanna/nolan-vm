...
bool vm::createStr(std::string& str, std::vector<std::byte>::iterator& bi, std::vector<std::byte>::iterator end) {
...
bool vm::createInt8(int64_t& integer, std::vector<std::byte>::iterator& bi, std::vector<std::byte>::iterator end) {
  if (++bi == end) return false;
  integer = static_cast<int64_t>(static_cast<uint8_t>(*bi));
  return true;
}

bool vm::createInt64(int64_t& integer, std::vector<std::byte>::iterator& bi, std::vector<std::byte>::iterator end) {
  if (++bi == end) return false;
...
bool vm::createFloat(double& floatNum, std::vector<std::byte>::iterator& bi, std::vector<std::byte>::iterator end) {
  if (++bi == end) return false;
